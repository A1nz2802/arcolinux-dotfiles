...
myEditor :: String
myEditor = "vscode"  -- Sets vscode as editor
...
myWorkspaces = [" www ", " dev ", " term ", " ref ", " git ", " dock ", " fs ", " media ", " misc "]
...
myKeys c =
  ...
  , ("M-g", addName "Move focus to master window"              $ windows W.focusMaster)
  ...
  -- Scrot
  ^++^ subKeys "Scrot"
  [ ("M-S-s", addName "Menu"           $ spawn "scrot -s")
  , ("M-s", addName "Window Nav"   $ spawn "scrot")]
